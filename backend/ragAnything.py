...
WORKING_DIR = "./rag_storage3"       # Existing vector DB folder
...
async def main(file_name: str | None = None):
    ...
    # await query_rag("TELL ME ABOUT TABLE WITH zn logs with dates")
...
async def run_all(folder_path: str):
    ...
    for file_name in os.listdir(folder_path):
        ...
        await main(full_path)


if __name__ == "__main__":
    folder = "../files"
    asyncio.run(run_all(folder))
